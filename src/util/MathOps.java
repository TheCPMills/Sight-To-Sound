...
public class MathOps {
    ...
    public static boolean betweenInclusiveExclusive(double value, double min, double max) {
        return value >= min && value < max;
    }

    public static boolean betweenExclusiveInclusive(double value, double min, double max) {
        return value > min && value <= max;
    }

    public static boolean inBounds(double x, double y, double minX, double minY, double maxX, double maxY) {
        return betweenInclusive(x, minX, maxX) && betweenInclusive(y, minY, maxY);
    }
}